...
def downloadSoundsFreesound(queryText="", API_Key="", outputDir="", topNResults=5, tag=None, duration=None,
                            featureExt='.json'):
    """
...
cat 'export FREESOUND_API_KEY="<paste your key here>"' >> ~/.profile && source ~/.profile
    ...
    downloadSoundsFreesound(queryText='trumpet', API_Key=Key, tag='single-note', duration=(0.5, 4), topNResults=20,
                            outputDir=output_dir)
    downloadSoundsFreesound(queryText='violin', API_Key=Key, tag='single-note', duration=(0.5, 4), topNResults=20,
                            outputDir=output_dir)
    downloadSoundsFreesound(queryText='flute', API_Key=Key, tag='single-note', duration=(0.5, 4), topNResults=20,
                            outputDir=output_dir)
