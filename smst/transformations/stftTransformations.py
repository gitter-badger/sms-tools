...
from ..models import dftModel as DFT
...
def stftFiltering(x, fs, w, N, H, filter):
	...
	y = np.delete(y, range(hM2))                   # delete half of first window which was added in stftModelAnal
...
def stftMorph(x1, x2, fs, w1, N1, w2, N2, H1, smoothf, balancef):
	...
	y = np.delete(y, range(hM1_2))                   # delete half of first window which was added in stftModelAnal
