...
class HpsTransformations_frame:
    ...
    def analysis(self):
        ...
        try:
            ...
            self.inputFile, self.fs, self.hfreq, self.hmag, self.mYst = hT.analysis(inputFile, window, M, N, t,
                                                                                    minSineDur, nH, minf0, maxf0, f0et,
                                                                                    harmDevSlope, stocf)
    ...
    def transformation_synthesis(self):
        ...
        try:
            ...
            hT.transformation_synthesis(inputFile, fs, hfreq, hmag, mYst, freqScaling, freqStretching,
