...
class HpsMorph_frame:
    ...
    def initUI(self):
        ...
        window1_option = OptionMenu(self.parent, self.w1_type, "rectangular", "hanning", "hamming", "blackman",
                                    "blackmanharris")
        ...
        window2_option = OptionMenu(self.parent, self.w2_type, "rectangular", "hanning", "hamming", "blackman",
                                    "blackmanharris")
    ...
    def analysis(self):
        ...
        try:
            ...
            self.inputFile2, self.hfreq2, self.hmag2, self.stocEnv2 = hM.analysis(inputFile1, window1, M1, N1, t1, \
                                                                                  minSineDur1, nH, minf01, maxf01,
                                                                                  f0et1, harmDevSlope1, stocf,
                                                                                  inputFile2, window2, M2, N2, t2,
                                                                                  minSineDur2, minf02, maxf02, f0et2,
                                                                                  harmDevSlope2)
    ...
    def transformation_synthesis(self):
        ...
        try:
            ...
            hM.transformation_synthesis(inputFile1, fs, hfreq1, hmag1, stocEnv1, inputFile2, hfreq2, hmag2, stocEnv2,
                                        hfreqIntp, hmagIntp, stocIntp)
