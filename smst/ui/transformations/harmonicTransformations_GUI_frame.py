...
class HarmonicTransformationsFrame:
    ...
    def analysis(self):
        ...
        try:
            ...
            self.inputFile, self.fs, self.hfreq, self.hmag = hT.analysis(inputFile, window, M, N, t, minSineDur, nH,
    ...
    def transformation_synthesis(self):
        ...
        try:
            ...
            hT.transformation_synthesis(inputFile, fs, hfreq, hmag, freqScaling, freqStretching, timbrePreservation,
                                        timeScaling)
